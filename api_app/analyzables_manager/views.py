...
class AnalyzableViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def history(self, request, pk=None):
        ...
        user_domain_wildcard_events_queryset = analyzable.user_domain_wildcard_events.visible_for_user(user).order_by("-date")
        user_ip_wildcard_events_queryset = analyzable.user_ip_wildcard_events.visible_for_user(user).order_by("-date")
        ...
        user_domain_wildcard_events = UserDomainWildCardEventSerializer(user_domain_wildcard_events_queryset, many=True).data
        user_ip_wildcard_events = UserIPWildCardEventSerializer(user_ip_wildcard_events_queryset, many=True).data
