...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('analyzers_manager', '0002_0019_analyzer_config_cloudflare_malicious_detector'),
    ]
