...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('analyzers_manager', '0002_0024_analyzer_config_cymru_hash_registry_get_observable'),
    ]
