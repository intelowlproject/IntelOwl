...
values = [{'parameter': {'python_module': {'module': 'greynoiseintel.GreyNoiseAnalyzer', 'base_path': 'api_app.analyzers_manager.observable_analyzers'}, 'name': 'greynoise_api_version', 'type': 'str', 'description': '[GreyNoise Enterprise API](https://docs.greynoise.io/docs/using-the-greynoise-api)', 'is_secret': False, 'required': False}, 'for_organization': False, 'value': 'v3', 'updated_at': '2024-02-09T10:52:17.256525Z', 'owner': None, 'analyzer_config': 'GreyNoiseCommunity', 'connector_config': None, 'visualizer_config': None, 'ingestor_config': None, 'pivot_config': None}]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('analyzers_manager', '0002_0048_analyzer_config_greynoise'),
    ]
