...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('analyzers_manager', '0002_0050_analyzer_config_hashlookupserver_get_file'),
    ]
