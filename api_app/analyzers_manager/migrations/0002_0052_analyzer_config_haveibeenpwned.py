...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('analyzers_manager', '0002_0051_analyzer_config_hashlookupserver_get_observable'),
    ]
