...
values = [{'parameter': {'python_module': {'module': 'honeydb.HoneyDB', 'base_path': 'api_app.analyzers_manager.observable_analyzers'}, 'name': 'honeydb_analysis', 'type': 'str', 'description': 'Choose which endpoint to query from the HoneyDB service (options are: `all`, `scan_twitter`, `ip_query`, `ip_history`, `internet_scanner`, `ip_info`)', 'is_secret': False, 'required': False}, 'for_organization': False, 'value': 'all', 'updated_at': '2024-02-09T10:52:17.355810Z', 'owner': None, 'analyzer_config': 'HoneyDB', 'connector_config': None, 'visualizer_config': None, 'ingestor_config': None, 'pivot_config': None}]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('analyzers_manager', '0002_0052_analyzer_config_haveibeenpwned'),
    ]
