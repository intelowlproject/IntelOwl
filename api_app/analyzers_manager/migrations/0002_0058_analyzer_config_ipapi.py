...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('analyzers_manager', '0002_0057_analyzer_config_hybridanalysis_get_observable'),
    ]
