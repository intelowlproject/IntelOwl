...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('analyzers_manager', '0002_0063_analyzer_config_intelx_intelligent_search'),
    ]
