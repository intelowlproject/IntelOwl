...
plugin = {
    ...
    "description": "Scan a file hash on Intezer. Register for a free community account [here](https://analyze.intezer.com/sign-in?utm_source=IntelOwl). With TLP `CLEAR`, in case the hash is not found, you would send the file to the service.",
    "disabled": False,
    "soft_time_limit": 300,
    "routing_key": "long",
