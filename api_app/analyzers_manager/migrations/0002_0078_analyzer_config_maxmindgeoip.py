...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('analyzers_manager', '0002_0077_analyzer_config_malwarebazaar_google_observable'),
    ]
