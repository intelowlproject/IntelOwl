...
values = [{'parameter': {'python_module': {'module': 'shodan.Shodan', 'base_path': 'api_app.analyzers_manager.observable_analyzers'}, 'name': 'shodan_analysis', 'type': 'str', 'description': '', 'is_secret': False, 'required': False}, 'for_organization': False, 'value': 'search', 'updated_at': '2024-02-09T10:52:19.396215Z', 'owner': None, 'analyzer_config': 'Shodan_Search', 'connector_config': None, 'visualizer_config': None, 'ingestor_config': None, 'pivot_config': None}]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('analyzers_manager', '0002_0105_analyzer_config_shodan_honeyscore'),
    ]
