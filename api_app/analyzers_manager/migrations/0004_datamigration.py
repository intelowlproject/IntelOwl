analyzers = {
    ...
    "Anomali_Threatstream_Confidence": {
        ...
        "disabled": False,
        "description": "Analyzer for threatstream API Confidence, give max, average and min confidence of entries for "
                       "an observable",
        "external_service": True,
        "leaks_info": False,
    ...
    "BitcoinAbuse": {
        ...
        "description": "Check a BTC address against bitcoinabuse.com, a public database of BTC addresses used by "
    ...
    "CapeSandbox": {
        ...
        "description": "Automatic scan of suspicious files using [CapeSandbox](https://github.com/kevoreilly/CAPEv2) "
                       "API",
        "disabled": False,
        "external_service": True,
        "leaks_info": True,
        ...
        "secrets": {
            ...
            "url_key_name": {
                ...
                "description": "URL for the CapeSandbox instance. If none provided, It uses the API provided by "
    ...
    "ClamAV": {
        ...
        "description": "scan files using [ClamAV AntiVirus Engine](https://www.clamav.net/). IntelOwl automatically "
        "keep ClamAV updated with official and [unofficial](https://github.com/rseichter/fangfrisch) open source "
        "signatures",
        "disabled": False,
        "leaks_info": False,
        "external_service": False,
    ...
    "CryptoScamDB_CheckAPI": {
        ...
        "description": "Scan a cryptocurrency address, IP address, domain or ENS name against the [CryptoScamDB]("
        "https://cryptoscamdb.org/) API.",
        "disabled": False,
        "external_service": True,
        "leaks_info": False,
    ...
    "CRXcavator": {
        ...
        "description": "Scans a chrome extension against crxcavator.io service. Every Chrome-Extension has a unique "
        "alpha=numeric identifier. That's the only Input necessary. Eg: `Norton Safe Search Enhanced`'s identifier is "
    ...
    "Dehashed_Search": {
        ...
        "description": "Query against Dehashed's search API. For configuration, refer to the 'Sizing & Pagination' "
        "section in [dehashed docs](https://www.dehashed.com/docs).",
        "disabled": False,
        "external_service": True,
        "leaks_info": False,
        "observable_supported": ["ip", "url", "domain", "hash", "generic"],
    ...
    "DNS0_EU_Malicious_Detector": {
        ...
        "description": "Check if a domain or an url is marked as malicious in DNS0.eu database ([Zero]("
        "https://www.dns0.eu/zero) service)",
        "disabled": False,
        "external_service": True,
        "leaks_info": False,
        "observable_supported": ["domain", "url"],
    ...
    "DNSDB": {
        ...
        "description": "Scan an observable against the Passive DNS Farsight Database (support both v1 and v2 "
        "versions). Official [API docs](https://docs.dnsdb.info/dnsdb-apiv2/).",
        "disabled": False,
        "external_service": True,
        "leaks_info": False,
    ...
    "Doc_Info": {
        ...
        "description": "static Microsoft Office document analysis ([Oletools](https://github.com/decalage2/oletools)) "
        "with features to analyze XLM macros, encrypted macros and much more",
        "disabled": False,
        "external_service": False,
        "leaks_info": False,
        "supported_filetypes": [
    ...
    "Doc_Info_Experimental": {
        "type": "file",
        "python_module": "doc_info.DocInfo",
        "description": "static Microsoft Office document analysis with new features to analyze XLM macros, "
        "encrypted macros and more [DEPRECATED, move to Doc_Info]",
        "disabled": True,
        "external_service": False,
        "leaks_info": False,
        "supported_filetypes": [
    ...
    "DocGuard_Upload_File": {
        ...
        "description": "Analyze office files in seconds. [DocGuard](https://www.docguard.io) Please register and use "
        "api-key to your privacy",
        "disabled": False,
        "external_service": True,
        "leaks_info": True,
        "supported_filetypes": [
    ...
    "FireHol_IPList": {
        ...
        "description": "Check if an IP is in FireHol's IPList. Refer to [FireHol's IPList]("
    ...
    "FileScan_Upload_File": {
        ...
        "description": "Extract IoCs from executable files, documents and scripts via [FileScan.io API]("
    ...
    "FileScan_Search": {
        ...
        "description": "Finds reports and uploaded files by various tokens, like hash, filename, verdict, "
        "IOCs etc via [FileScan.io API](https://www.filescan.io/api/docs).",
        "disabled": False,
        "external_service": True,
        "leaks_info": False,
    ...
    "GreedyBear": {
        ...
        "description": "scan an IP or a domain against the [GreedyBear]("
        "https://www.honeynet.org/2021/12/27/new-project-available-greedybear/) service",
        "disabled": False,
        "external_service": True,
        "leaks_info": False,
    ...
    "Hunter": {
        ...
        "description": "Scans a domain name and returns set of data about the organisation, the email address found "
        "and additional information about the people owning those email addresses",
        "disabled": False,
        "external_service": True,
        "leaks_info": False,
        "observable_supported": ["domain"],
    ...
    "Intezer_Get": {
        ...
        "description": "check if an hash was analyzed on Intezer. Register for a free community account [here]("
        "https://analyze.intezer.com/sign-in?utm_source=IntelOwl).",
        "disabled": False,
        "external_service": True,
        "leaks_info": False,
        "observable_supported": ["hash"],
    ...
    "Intezer_Scan": {
        ...
        "description": "Scan a file on Intezer. Register for a free community account [here]("
        "https://analyze.intezer.com/sign-in?utm_source=IntelOwl).",
        "disabled": False,
        "external_service": True,
        "leaks_info": True,
    ...
    "IPApi": {
        ...
        "description": "Gives information about [IPs](https://ip-api.com/docs/api:batch) and [DNS]("
    ...
    "OneNote_Info": {
        ...
        "description": "Extracting information from OneNote Office docs via [PyOneNote]("
    ...
    "Mnemonic_PassiveDNS": {
        ...
        "https://docs.mnemonic.no/display/public/API/Passive+DNS+Overview).",
        "disabled": False,
        "external_service": True,
        "leaks_info": False,
    ...
    "Spyse": {
        ...
        "description": "Scan domains, IPs, emails and CVEs using Spyse.com's API. Register [here]("
        "https://spyse.com/user/registration).",
        "disabled": False,
        "external_service": True,
        "leaks_info": False,
        "observable_supported": ["ip", "domain", "generic"],
    ...
    "SSAPINet": {
        ...
        "description": "Get a screenshot of a web page using screenshotapi.net. For configuration, Refer to the ["
    ...
    "Strings_Info": {
        ...
        "description": "Strings extraction. Leverages Mandiant's [Stringsifter]("
    ...
    "Strings_Info_ML": {
        "type": "file",
        "python_module": "strings_info.StringsInfo",
        "description": "strings extraction plus strings ranking based on Machine Learning. Leverages Fireeye's "
        "Stringsifter [DEPRECATED, move to Strings_Info]",
        "disabled": True,
        "external_service": False,
        "leaks_info": False,
        "docker_based": True,
    ...
    "Thug_HTML_Info": {
        ...
        "description": "Perform hybrid dynamic/static analysis on a saved HTML page. For configuration, "
        "refer to [thug's usage docs](https://buffer.github.io/thug/doc/usage.html#basic-usage).",
        "disabled": False,
        "external_service": False,
        "leaks_info": False,
        "docker_based": True,
    ...
    "Virushee_CheckHash": {
        ...
        "description": "Search for a previous analysis of a file by its hash (SHA256/SHA1/MD5) on [Virushee API]("
    ...
    "Virushee_Upload_File": {
        ...
        "description": "Check file hash and upload file sample for analysis on [Virushee API]("
        "https://api.virushee.com/).",
        "disabled": False,
        "external_service": True,
        "leaks_info": True,
    ...
    "VirusTotal_v3_Get_File": {
        ...
        "params": {
            ...
            "rescan_poll_distance": {
                "value": 120,
                "type": "int",
                "description": "IntelOwl would sleep for this time between each poll to VT APIs after having started "
                "a RE-scan"
            },
            ...
            "include_behaviour_summary": {
                "value": False,
                "type": "bool",
                "description": "Include a summary of behavioral analysis reports alongside default scan report. This "
                "will cost additional quota."
            },
            "include_sigma_analyses": {
                "value": False,
                "type": "bool",
                "description": "Include sigma analysis report alongside default scan report. This will cost "
                "additional quota."
            },
            "relationships_to_request": {
                "value": [],
                "type": "list",
                "description": "Include a list of relationships to request if available. Full list [here]("
                "https://developers.virustotal.com/reference/metadata). This will cost additional quota."
            },
    ...
    "VirusTotal_v3_Get_File_And_Scan": {
        "type": "file",
        "python_module": "vt.vt3_get.VirusTotalv3",
        "description": "check file hash on VirusTotal. If not already available, send the sample and perform a new "
        "scan",
        "disabled": False,
        "external_service": True,
        "leaks_info": True,
        ...
        "params": {
            ...
            "relationships_to_request": {
                "value": [],
                "type": "list",
                "description": "Include a list of relationships to request if available. This will cost additional "
                "quota."
            },
            "relationships_elements": {
                "value": 1,
    ...
    "VirusTotal_v3_Get_Observable": {
        ...
        "params": {
            ...
            "force_active_scan_if_old": {
                "value": False,
                "type": "bool",
                "description": "If you submitted an hash and the sample is old, it would be rescanned. This will cost "
                "additional quota."
            },
            "rescan_max_tries": {
                "value": 5,
            ...
            "include_behaviour_summary": {
                "value": False,
                "type": "bool",
                "description": "If you submitted an hash, include a summary of behavioral analysis reports alongside "
                "default scan report. This will cost additional quota."
            },
            "include_sigma_analyses": {
                "value": False,
                "type": "bool",
                "description": "If you submitted an hash, include sigma analysis report alongside default scan "
                "report. This will cost additional quota."
            },
            "relationships_to_request": {
                "value": [],
                "type": "list",
