...
plugin = {
    ...
    "name": "Ip2location",
    "description": "[API Docs](https://www.ip2location.io/ip2location-documentation) IP2Location.io allows users to check IP address location in real time.\r\n(Supports both with or without key)",
    "disabled": False,
    "soft_time_limit": 60,
    "routing_key": "default",
