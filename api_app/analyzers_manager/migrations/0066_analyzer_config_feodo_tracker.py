...
plugin = {
    "python_module": {
        ...
        "update_task": {
            ...
            "name": "api_app.analyzers_manager.observable_analyzers.feodo_tracker.Feodo_TrackerUpdate",
            "task": "intel_owl.tasks.update",
            "kwargs": '{"python_module_pk": 151}',
            "queue": "default",
            "enabled": True,
        },
...
params = [
    {
        ...
        "type": "bool",
        "description": "use recommended db",
        "is_secret": False,
        "required": False,
    },
    {
        ...
        "name": "update_on_run",
        "type": "bool",
        "description": "update analyzer db on every run",
        "is_secret": False,
        "required": False,
    },
]
...
values = [
    ...
    },
    {
        "parameter": {
            ...
            "name": "update_on_run",
            "type": "bool",
            "description": "update analyzer db on every run (Analyzer db is updated once in every 24 hours by default).",
            "is_secret": False,
            "required": False,
        },
        "analyzer_config": "Feodo_Tracker",
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("analyzers_manager", "0065_analyzer_config_validin"),
    ]
