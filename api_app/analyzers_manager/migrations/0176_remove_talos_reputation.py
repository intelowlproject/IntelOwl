# Generated by Django 4.2.27 on 2026-03-25 09:08
...
def remove_talos_forward(apps, schema_editor):
    ...
    # Remove the analyzer configuration entry first
    AnalyzerConfig.objects.filter(name='TalosReputation').delete()

    # Remove the related PythonModule/periodic task/schedules
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(remove_talos_forward, reverse_code=migrations.RunPython.noop),
    ]
