...
plugin = {
    ...
    "name": "IPQS_URL_File_Scanner",
    "description": "Scans files hosted or accessible via a URL using [IPQualityScore](https://www.ipqualityscore.com/) malware detection API.",
    "disabled": False,
    "soft_time_limit": 140,
    "routing_key": "default",
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("analyzers_manager", "0191_analyzer_config_ipqs_malware_file_scanner"),
    ]
