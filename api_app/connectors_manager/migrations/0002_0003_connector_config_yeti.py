...
plugin = {'name': 'YETI', 'python_module': {'module': 'yeti.YETI', 'base_path': 'api_app.connectors_manager.connectors'}, 'description': 'find or create observable on YETI, linking the successful analysis on IntelOwl.', 'disabled': False, 'soft_time_limit': 30, 'routing_key': 'default', 'health_check_status': True, 'maximum_tlp': 'CLEAR', 'run_on_failure': True, 'health_check_task': None, 'model': 'connectors_manager.ConnectorConfig'}
...
values = [{'parameter': {'python_module': {'module': 'yeti.YETI', 'base_path': 'api_app.connectors_manager.connectors'}, 'name': 'verify_ssl', 'type': 'bool', 'description': 'Enable SSL certificate server verification. Change this if your YETI instance has not SSL enabled.', 'is_secret': False, 'required': False}, 'for_organization': False, 'value': True, 'updated_at': '2024-02-09T10:52:16.260168Z', 'owner': None, 'analyzer_config': None, 'connector_config': 'YETI', 'visualizer_config': None, 'ingestor_config': None, 'pivot_config': None}]
