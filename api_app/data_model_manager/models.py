...
class BaseDataModel(models.Model):
    ...
    additional_info = models.JSONField(default=dict)  # field for additional information related to a specific analyzer
...
class IPDataModel(BaseDataModel):
    ...
    asn_rank = models.DecimalField(null=True, blank=True, default=None, decimal_places=20, max_digits=21)  # BGPRanking
    ...
    country_code = LowercaseCharField(max_length=100, null=True, blank=True, default=None)  # MaxMind, AbuseIPDB
    registered_country_code = LowercaseCharField(max_length=100, null=True, blank=True, default=None)  # MaxMind, AbuseIPDB
...
class FileDataModel(BaseDataModel):
    ...
    comments = SetField(LowercaseCharField(max_length=100), default=list, blank=True)  # MalwareBazaarFileAnalyzer,
    # VirusTotalV3FileAnalyzer (data.relationships.comments)
    file_information = models.JSONField(default=dict, blank=True)  # MalwareBazaarFileAnalyzer, OneNoteInfo (files),
