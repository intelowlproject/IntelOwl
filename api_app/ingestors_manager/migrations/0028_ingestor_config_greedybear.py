...
plugin = {
    ...
    "name": "GreedyBear",
    "description": "GreedyBear extracts data on attacks detected by a TPOT or a cluster of them and generates feeds.",
    "disabled": True,
    "soft_time_limit": 60,
    "routing_key": "ingester",
...
values = [
    {
        ...
        "value": "https://greedybear.honeynet.org/api/feeds/all/all/recent.json",
        "updated_at": "2025-01-28T14:35:31.763987Z",
        "owner": None,
    },
    {
        "parameter": {
        ...
        "for_organization": False,
        "value": 20,
        "updated_at": "2025-02-02T06:10:01.182438Z",
        "owner": None,
    },
]
