...
def migrate(apps, schema_editor):
    ...
    PivotConfig.objects.update(
        related_analyzer_configs2=ArraySubquery(
            PivotConfig.objects.filter(pk=models.OuterRef("pk")).values("related_analyzer_configs__name")
        ),
        related_connector_configs2=ArraySubquery(
            PivotConfig.objects.filter(pk=models.OuterRef("pk")).values("related_connector_configs__name")
        ),
