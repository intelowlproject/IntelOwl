...
def migrate(apps, schema_editor):
    ...
    for pivot in PivotConfig.objects.all():
        acs = AnalyzerConfig.objects.filter(name__in=pivot.related_analyzer_configs2)
        ccs = ConnectorConfig.objects.filter(name__in=pivot.related_connector_configs2)
