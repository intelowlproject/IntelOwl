...
plugin = {
    ...
    "related_analyzer_configs": ["PDF_Info"],
    "related_connector_configs": [],
    "playbook_to_execute": "Download_File",
    "name": "DownloadFileFromUri",
    "description": "Pivot for plugins PDF_Info that executes playbook Download_File",
    "disabled": False,
    "soft_time_limit": 60,
    "routing_key": "uris",
...
values = [
    {
        ...
        "pivot_config": "DownloadFileFromUri",
        "for_organization": False,
        "value": "uris",
        "updated_at": "2024-06-19T12:28:27.945297Z",
        "owner": None,
    }
]
