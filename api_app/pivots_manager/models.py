...
class PivotConfig(PythonConfig, CreateJobsFromPlaybookInterface):
    ...
    related_analyzer_configs = models.ManyToManyField("analyzers_manager.AnalyzerConfig", related_name="pivots", blank=True)
    related_connector_configs = models.ManyToManyField("connectors_manager.ConnectorConfig", related_name="pivots", blank=True)
