...
def migrate(apps, schema_editor):
    ...
    for playbook in PlaybookConfig.objects.all():
        pivots = PivotConfig.objects.filter(name__in=playbook.pivots2).values_list("pk", flat=True)
            ...
            for org in playbook.disabled2:
                if org:
                    OrganizationPluginConfiguration.objects.create(
                        organization=org, object_id=playbook.pk,content_type=ct,  disabled=True
                    )
