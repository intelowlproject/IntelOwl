...
plugin = {
    "analyzers": ["BoxJS", "Doc_Info", "Lnk_Info", "PDF_Info", "Strings_Info"],
    "connectors": [],
    "pivots": ["DownloadFileFromUri"],
    "for_organization": False,
    "name": "Uris",
    "description": 'A playbook containing only the analyzers that extract "uris".',
    "disabled": False,
    "type": ["file"],
