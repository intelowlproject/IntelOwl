...
def run(analyzer_name, job_id, observable_name, observable_classification, additional_config_params):
    ...
    try:
        ...
        result = shodan_get_report(api_key, observable_name, analyzer_name, observable_classification)
...
def shodan_get_report(api_key, observable_name, analyzer_name, observable_classification):
