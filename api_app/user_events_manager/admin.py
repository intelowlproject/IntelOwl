...
class UserAnalyzableEventAdmin(admin.ModelAdmin):
    list_display = ["pk", "user", "analyzable", "date", "data_model", "decay_progression", "decay_timedelta_days", "next_decay"]
...
class UserDomainWildCardEventAdmin(admin.ModelAdmin):
    list_display = ["pk", "user", "query", "get_analyzables", "date", "data_model", "decay_progression", "decay_timedelta_days", "next_decay"]
    list_filter = ["user", "date", "next_decay"]
    ordering = ["date"]
...
class UserDomainWildCardEventAdmin(admin.ModelAdmin):
    list_display = ["pk", "user", "start_ip","end_ip", "get_analyzables", "date", "data_model", "decay_progression", "decay_timedelta_days", "next_decay"]
    list_filter = ["user", "date", "next_decay"]
    ordering = ["date"]
    search_fields = ["analyzables"]
