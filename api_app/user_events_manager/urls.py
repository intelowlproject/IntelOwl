...
from api_app.user_events_manager.views import UserIPWildCardEventViewSet, UserAnalyzableEventViewSet, \
...
router.register(r"domain_wildcard", UserDomainWildCardEventViewSet, basename="user_domain_analyzable_event")
