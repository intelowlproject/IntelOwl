...
plugin = {
    ...
    "python_module": {
        "module": "domain_reputation_services.DomainReputationServices",
    ...
    "playbooks": ["Popular_URL_Reputation_Services"],
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("visualizers_manager", "0002_0000_visualizer_config_dns"),
    ]
