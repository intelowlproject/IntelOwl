...
plugin = {
    "name": "IP_Reputation",
    "python_module": {
        "module": "ip_reputation_services.IPReputationServices",
    ...
    "playbooks": ["Popular_IP_Reputation_Services"],
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("visualizers_manager", "0002_0001_visualizer_config_domain_reputation"),
    ]
