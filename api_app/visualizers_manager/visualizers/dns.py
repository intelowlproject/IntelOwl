    ...
    def run(self) -> List[Dict]:
                            ...
                            data=[
                                {
                                    "c1": self.VList(
                                        value=[
                                            self.HList(
                                                value=[
                                                    self.Base("r1 e1 1", disable=False),
                                                    self.Base("r1 e1 2", disable=False),
                                                ]
                                            ),
                                            self.HList(
                                                value=[
                                                    self.Base("r1 e2 1", disable=False),
                                                    self.Base("r1 e2 2", disable=False),
                                                ]
                                            ),
                                        ]
                                    ),
                                    "c2": self.Base(value="c2 r1", disable=False),
                                },
                                {
                                    "c1": self.VList(
                                        value=[
                                            self.HList(
                                                value=[
                                                    self.Base("r2 e1 1", disable=False),
                                                    self.Base("r2 e1 2", disable=False),
                                                ]
                                            ),
                                            self.HList(
                                                value=[
                                                    self.Base("r2 e2 1", disable=False),
                                                    self.Base("r2 e2 2", disable=False),
                                                ]
                                            ),
                                        ]
                                    ),
                                    "c2": self.Base(value="c2 r2", disable=False),
                                },
                                {
                                    "c1": self.VList(
                                        value=[
                                            self.HList(
                                                value=[
                                                    self.Base("r3 e1 1", disable=False),
                                                    self.Base("r3 e1 2", disable=False),
                                                ]
                                            ),
                                            self.HList(
                                                value=[
                                                    self.Base("r3 e2 1", disable=False),
                                                    self.Base("r3 e2 2", disable=False),
                                                ]
                                            ),
                                        ]
                                    ),
                                    "c2": self.Base(value="c2 r3", disable=False),
                                },
                                {
                                    "c1": self.VList(
                                        value=[
                                            self.HList(
                                                value=[
                                                    self.Base("r4 e1 1", disable=False),
                                                    self.Base("r4 e1 2", disable=False),
                                                ]
                                            ),
                                            self.HList(
                                                value=[
                                                    self.Base("r4 e2 1", disable=False),
                                                    self.Base("r4 e2 2", disable=False),
                                                ]
                                            ),
                                        ]
                                    ),
                                    "c2": self.Base(value="c2 r4", disable=False),
                                },
                                {
                                    "c1": self.VList(
                                        value=[
                                            self.HList(
                                                value=[
                                                    self.Base("r5 e1 1", disable=False),
                                                    self.Base("r5 e1 2", disable=False),
                                                ]
                                            ),
                                            self.HList(
                                                value=[
                                                    self.Base("r5 e2 1", disable=False),
                                                    self.Base("r5 e2 2", disable=False),
                                                ]
                                            ),
                                        ]
                                    ),
                                    "c2": self.Base(value="c2 r5", disable=False),
                                },
                            ],
                            size=self.Size.S_6,
                        )
        ...
        page.add_level(
            self.Level(
                ...
                size=self.LevelSize.S_5,
                horizontal_list=self.HList(
                    value=[self.Base(value="test", disable=False)]
                ),
            )
        )

        return [page.to_dict(), page2.to_dict()]
