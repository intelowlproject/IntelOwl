...
* `DNS0_names`: Run advanced searches on billions of current and historical domain names.
* `DNS0_rrsets_data`: Query billions of current and historical DNS resource records sets. Performs right-hand side matching.
* `DNS0_rrsets_name`: Query billions of current and historical DNS resource records sets. Performs left-hand side matching.
