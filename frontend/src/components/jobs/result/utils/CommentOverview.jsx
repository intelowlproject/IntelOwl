...
import { Col, Row, Button, Form, FormGroup, Container, Card, CardBody, CardHeader } from "reactstrap";
            ...
            <Col>
                ...
                >
                    ...
                    <Card key={comment.id} className="mb-3">
                        ...
                        <span className="ms-2 text-secondary">{formatDate(comment.created_at)}</span>
                        </CardHeader>
                        <CardBody>
                        <p>{comment.content}</p>
                        {comment.current_user && (
                            <div className="d-flex justify-content-end">
                            <Button onClick={() => handleDeleteComment(comment.id)} color="danger">
                                Delete
                            </Button>
                            </div>
                        )}
