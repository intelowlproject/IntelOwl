...
function NameFilter({ column: { filterValue, setFilter, preFilteredRows } }) {
  ...
  const selectedOption = React.useMemo(
    () => options.find((opt) => opt.value === filterValue) || null,
    [options, filterValue],
  );

  const nameFilterStyles = React.useMemo(
    () => ({
      ...selectStyles,
      container: (base) => ({
        ...base,
  ...
  return (
    <div className="w-100 px-1">
      <ReactSelect
        ...
        options={options}
        styles={nameFilterStyles}
        value={selectedOption}
        placeholder="Search..."
        onChange={(opt) => setFilter(opt ? opt.value : undefined)}
