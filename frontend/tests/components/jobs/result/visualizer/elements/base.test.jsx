...
describe("BaseVisualizer component", () => {
    ...
    test("required-only params", () => {
        ...
        const innerPartComponent = screen.getByText('test base (required-only params)');
        ...
        expect(outerPartComponent.className).toBe("col-1 small d-flex align-items-center text-center justify-content-center  ");
    });
    ...
    test("all params", () => {
        ...
        const outerPartComponent = innerPartComponent.closest("div");
        expect(outerPartComponent.className).toBe("col-2 small d-flex align-items-center text-start justify-content-start  success");
    });
    ...
    test("test disable", () => {
        ...
        // check optional elements (like bold, italic...)
        const outerPartComponent = innerPartComponent.closest("div");
        expect(outerPartComponent.className).toBe("col-2 small d-flex align-items-center text-start justify-content-start opacity-25 success");
