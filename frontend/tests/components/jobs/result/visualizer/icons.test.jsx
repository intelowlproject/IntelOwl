const { getIcon } = require("../../../../../src/components/jobs/result/visualizer/icons");

describe("visualizer icon module", () => {

    test("check defined icons", () => {
        // check icons based on react-icons
        ["info", "like", "dislike", "heart", "malware",
        "warning", "shield", "fire", "alarm", "magnifyingGlass",
        "creditCard", "email", "hook", "filter", "incognito", "inbox",
        "cloudUpload", "cloudSync", "lighthouseOn", "controller",
        "exit", "connection", "locker", "otx", "github"].forEach(iconCode => {
        ...
        ["quokka", "hybridAnalysis", "urlhaus", "google", "cloudflare", "quad9"].forEach(iconCode => {
            const icon = getIcon(iconCode);
