...
describe("test VisualizerReport (conversion from backend data to frontend components)", () => {
    ...
    test("visualizer failed with error", () => {
        ...
        expect(screen.getByText('An error occurred during the rendering')).toBeInTheDocument();
    ...
    test("valid data", () => {
        ...
        */
        ...
        const vListComponent = within(container.firstChild.firstChild).getByText("vlist title");
        expect(vListComponent).toBeInTheDocument();
        const titleComponent = within(container.firstChild.firstChild).getByText("title title");
        expect(titleComponent).toBeInTheDocument();
        expect(within(container.firstChild.firstChild).queryByText("base component")).toBeNull()
        expect(within(container.firstChild.firstChild).queryByText("bool component")).toBeNull()
