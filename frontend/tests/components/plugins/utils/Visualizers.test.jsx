...
import Visualizers from "../../../../src/components/plugins/utils/Visualizers";
...
describe("test Visualizers component", () => {
    test("Table columns", async () => {
      ...
      const playbookConnectedToColumnHeader = screen.getByRole("columnheader", { name: "Playbook connected to All" });
