...
describe("Regex constant", () => {
  ...
  test("test UUIDs regex", () => {
    expect(UUID_REGEX.test("1b4cb389-43f3-4d04-9404-0b37bf76c0af")).toBeTruthy();
  });
  ...
  test("test MD5s regex", () => {
    ...
    // sha1
    expect(HASH_REGEX.test("40ff44d9e619b17524bf3763204f9cbb204f9cbb")).toBeTruthy();
    // sha256
    expect(HASH_REGEX.test("838c4c2573848f58e74332341a7ca6bc5cd86a8aec7d644137d53b4d597f10f5")).toBeTruthy();
    // sha512
    expect(HASH_REGEX.test("eab5a87ed85c694995a831f03ab397faa300c8674896ab5dbfa6923a46b5bc7266bfb6a017c18023e9dc086a60ccab94053e61e849a0d904da8d031f87165953")).toBeTruthy();
    // check other observable not matched
