...
describe("AuthGuard Component", () => {
    ...
    test("redirects to login if user is unauthenticated and no cookie is present", () => {
        ...
        expect(mockFetchUserAccess).not.toHaveBeenCalled();
        expect(addToast).toHaveBeenCalledWith("Login required to access the requested page.", null, "info");
        expect(screen.getByTestId("location-display")).toHaveTextContent("/login?next=/protected");
    });
    ...
    test("redirects to home(/) without ?next if redirecting from a logout path", () => {
        ...
        expect(screen.getByTestId("location-display")).not.toHaveTextContent("login");
