...
from api_app.script_analyzers.observable_analyzers import abuseipdb, fortiguard, maxmind, greynoise, googlesf, otx, \
    ...
    shodan, honeydb_twitter_scan, honeydb_nodes_scan, hunter
...
@shared_task(soft_time_limit=500)
def honeydb_nodes_scan_run(analyzer_name, job_id, observable_name, observable_classification, additional_config_params):
    honeydb_nodes_scan.run(analyzer_name, job_id, observable_name, observable_classification, additional_config_params)
