...
![Version: 1.0.0](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v6.5.0](https://img.shields.io/badge/AppVersion-v6.5.0-informational?style=flat-square)
...
This step is **required** to access IntelOwl. Create your first admin account:
...
- **Email address**: Your email (optional but recommended)
- **Password**: A strong password (min 8 characters, mixed case, numbers)
...
```
     ...
     │                 │               │               │
┌──────▼──────┐ ┌──────▼──────┐ ┌──────▼──────┐ ┌──────▼──────┐
│ PostgreSQL  │ │    Redis/   │ │ Celery Beat │ │   Celery    │
│   (CNPG)    │ │   RabbitMQ  │ │ (Scheduler) │ │   Workers   │
└─────────────┘ └─────────────┘ └─────────────┘ └─────────────┘
```
...
| ----------------------------------------- | -------------------- | ------- |
| <https://cloudnative-pg.github.io/charts> | cnpg(cloudnative-pg) | 0.23.\* |
| oci://registry-1.docker.io/cloudpirates   | rabbitmq(rabbitmq)   | 0.15.\* |
| oci://registry-1.docker.io/cloudpirates   | redis(redis)         | 0.21.\* |
...
| app.version               | string | `"v6.5.0"` | IntelOwl application version                                                                                                                            |
...
| integrations.nuclei.image.repository                                       | string | `"intelowlproject/nuclei_analyzer"`                                 | Nuclei image repository                                   |
...
| integrations.phishingAnalyzers.selenium.chromium.image.tag                 | string | `"132.0.6834.159-chromedriver-132.0.6834.159-grid-4.28.1-20250202"` | Chromium node image tag                                   |
...
| integrations.phishingAnalyzers.selenium.hub.image.tag                      | string | `"4.28.1"`                                                          | Selenium Hub image tag                                    |
...
| Key                      | Type   | Default                                                                                             | Description                                          |
| ------------------------ | ------ | --------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| containerSecurityContext | object | `{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"readOnlyRootFilesystem":false}` | Container security context applied to all containers |
