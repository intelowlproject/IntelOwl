...
@click.option("--traefik", default=False, is_flag=True)
@click.option("--multi_queue", default=False, is_flag=True)
@click.option("--thug", default=False, is_flag=True)
@click.option("--static_analyzers", default=False, is_flag=True)
@click.option("--box_js", default=False, is_flag=True)
@click.option("--apk_analyzers", default=False, is_flag=True)
@click.option("--all_analyzers", default=False, is_flag=True)
@click.pass_context
def start(
    ctx,
    mode,
