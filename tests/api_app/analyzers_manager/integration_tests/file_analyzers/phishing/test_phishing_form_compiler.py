...
class PhishingFormCompilerTestCase(TestCase):
    def test_extract_action_attribute_url(self):
        ...
        self.assertEqual(
            PhishingFormCompiler.extract_action_attribute("https://test.com", {"action": "https://test2.com"}),
            "https://test2.com",
        )
        ...
        self.assertEqual(
            PhishingFormCompiler.extract_action_attribute("https://test.com/another", {"action": "https://test2.com"}),
            "https://test2.com",
        )

        self.assertEqual(
            PhishingFormCompiler.extract_action_attribute("https://test.com/another.php?test=y", {"action": "https://test2.com/"}),
            "https://test2.com/",
        )

        self.assertEqual(
            PhishingFormCompiler.extract_action_attribute("https://test.com/another.php?test=y", {"action": "/test2"}),
            "https://test.com/test2",
        )

        self.assertEqual(
            PhishingFormCompiler.extract_action_attribute("https://test.com/test.php/", {"action": "/test2.php"}),
        ...
        self.assertEqual(
            PhishingFormCompiler.extract_action_attribute("https://test.com/test.php", {"action": "test.php"}),
            "https://test.com/test.php",
        )
        ...
        self.assertEqual(
            PhishingFormCompiler.extract_action_attribute("https://test.com:11111/test.php", {"action": "test"}),
    ...
    def test_extract_action_attribute_domain(self):
        ...
        self.assertEqual(
            PhishingFormCompiler.extract_action_attribute("test.com/another", {"action": "https://test2.com"}),
            "https://test2.com",
        )

        self.assertEqual(
            PhishingFormCompiler.extract_action_attribute("test.com/another.php?test=y", {"action": "https://test2.com/"}),
            "https://test2.com/",
        )

        self.assertEqual(
            PhishingFormCompiler.extract_action_attribute("test.com/another.php?test=y", {"action": "/test2"}),
            "https://test.com/test2",
        )
