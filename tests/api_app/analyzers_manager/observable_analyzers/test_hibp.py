...
from api_app.analyzers_manager.observable_analyzers.hibp_passwords import HibpPasswords
from api_app.analyzers_manager.observable_analyzers.hibp_breaches import HibpBreaches
...
class HibpPasswordsTestCase(TestCase):
    ...
    @patch("api_app.analyzers_manager.observable_analyzers.hibp_passwords.make_hibp_request")
    def test_pwned_password_found(self, mock_make_request):
        # SHA-1("password") upper =
    ...
    def test_password_not_found(self, mock_make_request):
        ...
        self.assertEqual(result["summary"], "Password not found in known breaches.")
...
class HibpBreachesTestCase(TestCase):
    ...
    @patch("api_app.analyzers_manager.observable_analyzers.hibp_breaches.make_hibp_request")
    def test_email_found(self, mock_make_request):
        mock_make_request.return_value = [{"Name": "TestBreach", "PwnCount": 100}]
