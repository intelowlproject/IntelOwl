...
class PlaybookConfigViewSetTestCase(AbstractConfigViewSetTestCaseMixin, CustomViewSetTestCase):
    ...
    def test_delete(self):
        ...
        p_custom_user = PlaybookConfig.objects.create(name="test2", type=["ip"], tlp="CLEAR", owner=m_user.user)
        ...
        p_custom_org1 = PlaybookConfig.objects.create(name="test4", type=["ip"], tlp="CLEAR", owner=m_user.user)
