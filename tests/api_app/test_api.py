...
class ApiViewTests(CustomViewSetTestCase):
    def setUp(self):
        ...
        self.observable_md5 = hashlib.md5(  # nosec B324
    ...
    def __get_test_file(fname: str) -> Tuple[SimpleUploadedFile, str]:
        ...
        md5 = hashlib.md5(binary).hexdigest()  # nosec B324
    ...
    def test_analyze_observable__domain(self):
        ...
        md5 = hashlib.md5(observable_name.encode("utf-8")).hexdigest()  # nosec B324
