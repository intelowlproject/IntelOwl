...
class VisualizerConfigViewSetTestCase(AbstractConfigViewSetTestCaseMixin, CustomViewSetTestCase):
    URL = "/api/visualizer"
    ...
    def test_get(self):
        ...
        self.assertEqual(result, {"detail": "No VisualizerConfig matches the given query."})
